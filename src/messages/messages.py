...
Это бот нужен для получения данных о погоде.
...
weather_forecast_days_message = """На сколько дней делать прогноз? """
weather_requesting_data_message = """Пожалуйста, подождите..."""